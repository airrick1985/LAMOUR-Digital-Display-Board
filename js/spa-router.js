...
if (!window._spaRouterInitialized) {
    ...
    async function navigate(url) {
        ...
        try {
            ...
            const pageSpecificCSSPatterns = ['brand.css', 'location.css', 'google-map.css', 'floor-plan.css', 'exterior-3d.css', 'public-3d.css', 'panorama.css', 'coming-soon.css', 'materials.css', 'construction.css', 'basic-info.css'];
